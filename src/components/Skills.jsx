                ...
                <div 
                    ...
                    <div className="flex  text-white">
                        ...
                        <div className="text-lg w-1/2 px-20 text-center">
                            ...
                            <p> {/*className="text-lg" */}
                            Proficient in a diverse array of programming languages and technologies, with a focus on both frontend and backend development for web applications.
                            Skilled in harnessing contemporary frameworks and tools to craft immersive user interfaces. Possesses adept problem-solving abilities, strong communication skills, and a collaborative mindset, driven by a intense dedication to ongoing learning and industry evolution.
                            </p>
                    ...
                    <div className="flex justify-center">
                        {/* Skills */} 
                        {/* space-x-2 */}
                        <div className="flex  space-x-5 space-y-3 w-2/2 h-fit items-center flex-wrap">
